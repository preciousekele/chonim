  ...
  return (
    <div className="flex flex-col gap-0 w-full">
      ...
      <p className="choko-story-p">
        On the 16th of September 2024, I was on a trip— not just any trip, but a
        very serious Kingdom assignment.
        <br />
        Destination: United Kingdom. <br /> Reason: Sound of Revival.
      </p>
      <p className="choko-story-p">
        I was traveling with my Father, Apostle Joshua Selman, and other team
        members, so you can imagine my mindset — focused, serious, zero
        distractions. Love? Romance? "Woman dey where?" Not even in my prayer
        points because I was never even a fan of distance relationships neither
        did I ever love the idea of living outside Abuja.
      </p>
      ...
      <p className="choko-story-p">
        At the British Airways counter in Abuja, I noticed a lady on another
        queue checking in for the same flight.
        <br />
        Did I approach her? No.
        <br />
        Did I think anything of it? Absolutely not.
        <br />
        To me, she was just another passenger on the flight. <br /> Mission
        first. Always.
      </p>

      <div className="choko-chapter-head">On the Flight</div>
      <p className="choko-story-p">
        Boarded. Sat down. Looked around.
        <br />
        And yes… I saw her again.
        <br />
        Still nothing.
        <br />
        No spark. No "this could be my wife." Just vibes, in-flight
        announcements and a plan to sleep all through the flight.
      </p>
...
function ProfileCard({ profile, index }) {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ...
      { threshold: 0.05, rootMargin: "0px 0px -50px 0px" }, // 👈 this line
    );
      ...
      >
        ...
        <div
          className={`relative flex-shrink-0 w-full md:w-[430px] ${
            isLeft ? "pb-10 md:pb-0" : "-mt-12 md:pt-0"
          }`}
        >
